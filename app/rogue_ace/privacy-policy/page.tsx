    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="prose prose-lg max-w-none">
        ...
        <div className="space-y-6 text-gray-700">
          <p>
            This Privacy Notice for Akolo Technologies LLC ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
          </p>
          
          <ul className="list-disc pl-6 space-y-2">
            <li>Download and use our mobile application (The Rogue Ace), or any other application of ours that links to this Privacy Notice</li>
            <li>Engage with us in other related ways, including any sales, marketing, or events</li>
          </ul>
          
          <p>
            <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at johnnychen762@gmail.com.
          </p>
          ...
          <p><em>If you are located in Canada, this section applies to you.</em></p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">7. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Withdrawing your consent:</h3>
          ...
          <p>If you have questions or comments about your privacy rights, you may email us at johnnychen762@gmail.com.</p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">9. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Categories of Personal Information We Collect</h3>
          ...
          <p className="mt-6">We may also collect other personal information outside of these categories through instances where you interact with us in person, online, or by phone or mail in the context of:</p>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <p>Learn more about the sources of personal information we collect in "WHAT INFORMATION DO WE COLLECT?" above.</p>
          
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">How We Use and Share Personal Information</h3>
          ...
          <p>We may disclose your personal information with our service providers pursuant to a written contract between us and each service provider. Learn more about how we disclose personal information to in the section, "WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?" above.</p>
          ...
          <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at johnnychen762@gmail.com, or by referring to the contact details at the bottom of this document.</p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Request Verification</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Appeals</h3>
          <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at johnnychen762@gmail.com. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
          
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">California "Shine The Light" Law</h3>
          <p>California Civil Code Section 1798.83, also known as the "Shine The Light" law, permits our users who are California residents to request and obtain from us, once a year and free of charge, information about categories of personal information (if any) we disclosed to third parties for direct marketing purposes and the names and addresses of all third parties with which we shared personal information in the immediately preceding calendar year. If you are a California resident and would like to make such a request, please submit your request in writing to us by using the contact details provided in the section "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?" above.</p>
          ...
          <p>If you have questions or comments about this notice, you may email us at johnnychen762@gmail.com or contact us by post at:</p>
          
          <div className="bg-gray-50 p-4 rounded-lg mt-4">
            <p className="font-semibold">Akolo Technologies LLC</p>
            <p>566 Skiff Cir</p>
